...
using Tyuiu.GornovTA.Sprint3.Task7.V20.Lib;

namespace Tyuiu.GornovTA.Sprint3.Task7.V20
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* ноль. При делении на ноль вернуть значение 0. Значение округлить.       *");
            Console.WriteLine("***************************************************************************");
